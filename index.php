  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <h1>Все наборы открытых данных (73)</h1>
      </div>
    </div>
  </div>
      ...
      <div class="open_date_list">
        ...
        <div class="item">
          ...
          <div class="row vertical-align">
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
              <a href="#" class="title_item">Выставки муниципальных музеев</a> 
            </div>
          ...
          <div class="top_info_item">
            <div class="row">
              <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
               ...
               <a href="#"><i class="fa fa-bookmark-o" aria-hidden="true"></i>История и культура</a> 
              </div>
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-right">
            ...
            <div class="middle_info_item text-justify">
              <p>В наборе собраны все выставки начиная с 2010 года и включая еще идущие. Приводятся сведения о выставочных площадках, количестве экспонатов, посещаемости и организаторах. Набор может быть полезен для анализа доступности выставочных мероприятий.</p>
            </div>

            <div class="bottom_info_item">
              <a href="#"><i class="fa fa-university" aria-hidden="true"></i>Департамент культуры</a>  
            </div>
        </div> 
          ...
          <div class="row vertical-align">
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
              <a href="#" class="title_item">Ремонт дорог с заменой покрытия по всей ширине проезжей части</a> 
            </div>
          ...
          <div class="top_info_item">
            <div class="row">
              <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
               <div class="info_icons_block">
                <i class="fa fa-pencil-square-o" aria-hidden="true"></i><span>238</span>
                <i class="fa fa-eye" aria-hidden="true"></i><span>1330</span>
                <i class="fa fa-download" aria-hidden="true"></i><span>400</span>
               </div>
               <a href="#"><i class="fa fa-bookmark-o" aria-hidden="true"></i>Транспорт и дороги</a> 
              </div>
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-right">
              <p>Обновлено: 3 августа 2016 г.</p>
              <p>Опубликовано: 8 июня 2016 г.</p>
            </div>
            </div>
          </div>
            ...
            <div class="bottom_info_item">
              <a href="#"><i class="fa fa-university" aria-hidden="true"></i>Департамент городского хозяйства</a>  
            </div>
        </div>   
      ...
      <div id="sidebar_right" > 
        <div class="sidebar_menu">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="#"><span>Спорт и молодежная политика (8)</span></a></li>
